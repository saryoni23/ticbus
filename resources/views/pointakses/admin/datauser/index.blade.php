...
<div class="hidden absolute bottom-0 left-0 justify-center p-4 space-x-4 w-full lg:flex bg-white dark:bg-gray-800 z-20">
    ...
    <button type="button" data-dropdown-toggle="language-dropdown"
        ...
        <div class="inline-flex items-center">
            <svg class="h-5 w-5 rounded-full mr-2" xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-de"
                viewBox="0 0 512 512">
...
@section('main')
<main class="p-4 md:ml-64 h-full pt-16 bg-gray-200 dark:bg-gray-900">
                            ...
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-neutral-700 ">
                                ...
                                <td class="p-4 space-x-2 whitespace-nowrap">
                                    <div
                                        ...
                                        <form action="/hapususer/{{ $item->id }}" method="post" class="d-inline">
                                            @csrf
                                            <button data-modal-toggle="delete-user-modal"
                                                ensubmit="return confirmHapus(even);" type="submit"
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="position"
                                    ...
                                    Telepon</label>
                                <input type="number" name="position" value="React Developer" id="position"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    ...
                    <form action="#">
                        <div class="grid grid-cols-1 gap-3">
                            ...
                            <div class="col-span-2 sm:col-span-3">
                                <label for="position"
                                    class="block mb-2 text-sm font-medium text-gray-950  dark:text-white">Position</label>
                                <select data-te-select-init
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block  p-2.5 dark:bg-gray-700 dark:border-gray-600  dark:text-white ">
                                    @foreach($data as $item)
                                    {{ $item->role}}
                                    <option class="bg-slate-300 dark:bg-slate-400" value="{{ $item->role}}">
                                        {{ $item->role}}</option>
                                    @endforeach
                                </select>
                            </div>
