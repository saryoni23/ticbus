                ...
                <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
                    <div
                        ...
                        <ul class="pb-2 space-y-2">
                            ...
                            <li>
                                <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700" aria-controls="dropdown-crud" data-collapse-toggle="dropdown-crud" aria-expanded="true">
                                ...
                                <ul id="dropdown-crud" class="space-y-2 py-2">
                                  ...
                                  <li>
                                    <a href="/usercontrol" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">User Control</a>
                                  </li>
                                </ul>
                              </li>
                            <li>
                ...
                <div class="absolute bottom-0 left-0 justify-center hidden w-full p-4 space-x-4 bg-white lg:flex dark:bg-gray-800"
                    ...
                    <button type="button" data-dropdown-toggle="language-dropdown"
                        ...
                        <div class="inline-flex items-center">
                            <svg class="h-5 w-5 rounded-full mr-2" xmlns="http://www.w3.org/2000/svg"
                                id="flag-icon-css-de" viewBox="0 0 512 512">
                                <path fill="#ffff" d="M0 256.3h512V512H0z" />
                                <path fill="#FF0000" d="M0 0.7h512v256.1H0z" />
                            </svg>
          ...
          <div class="flex items-center justify-center h-24 rounded bg-gray-50 dark:bg-gray-800">
             <p class="text-2xl text-gray-400 dark:text-gray-500">
                <div class="flex-shrink-0 text-center">
                    <span class="text-xl font-bold leading-none text-gray-900 sm:text-2xl dark:text-white">Halo {{ Auth::user()->fullname }}</span>
                    <h3 class="text-base font-light text-gray-500 dark:text-gray-400">{{ Auth::user()->role }}</h3>
                  </div>
             </p>
          </div>
          <div class="flex items-center justify-center h-24 rounded bg-gray-50 dark:bg-gray-800">
