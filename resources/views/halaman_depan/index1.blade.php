            ...
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                ...
                <div class="text-center">
                    ...
                    <p class="mt-6 text-lg leading-8 text-gray-600">
                        ...
                        elit. Fuga laborum, impedit voluptate beatae,
                        cupiditate temporibus velit soluta optio nam magni
                        porro explicabo earum, possimus nisi placeat
                        laboriosam consequatur. Perspiciatis, accusantium..
                    </p>
                    <div class="mt-10 flex items-center justify-center gap-x-6">
                        <a href="/tiket" class="text-sm font-semibold leading-6 text-gray-900 dark:text-white">Lihat
                            Tiket Lain
