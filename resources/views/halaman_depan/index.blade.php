...
<body class="bg-gray-200 dark:bg-abutua">
    <header class="bg-gray-200 dark:bg-black">
        <div class="container">
            <nav class="bg-white dark:bg-gray-900 fixed w-full z-40 top-0 left-0 border-b border-gray-200 dark:border-gray-600 bg-opacity-80 dark:bg-opacity-80 bg-clip-padding blur-backdrop-fillter">
            ...
            <div id="indicators-carousel" class="relative w-full" data-carousel="static">
                ...
                <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
                    ...
                    <div class="hidden duration-700 ease-in-out" data-carousel-item="active">
                        <img src="{{ asset('picture/bus/2022-05-31.jpg') }}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                    </div>
                    <!-- Item 2 -->
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img src="{{ asset('picture/bus/unnamed.jpg') }}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                    </div>
                    <!-- Item 3 -->
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img src="{{ asset('picture/bus/2020-01-28 (2).jpg') }}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                    </div>
                    <!-- Item 4 -->
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img src="{{ asset('picture/bus/2020-01-28 (1).jpg') }}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                    </div>
                    <!-- Item 5 -->
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img src="{{ asset('picture/bus/2023-10-15.jpg') }}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                    </div>
                </div>
                <!-- Slider indicators -->
                        ...
                        {{-- <form action="" method="" class="mb-4"> --}}
                            ...
                            {{-- <div class="grid grid-cols-2 gap-4"> --}}
                                <!-- <div class="p-4 border rounded-lg shadow-lg">
                                    <h3 class="text-xl font-semibold mb-2 dark:text-white">Tiket Ekonomi</h3>
                                    <label class="dark:text-white" for="from">From:</label>
                                    <select name="from" id="from" class="border rounded p-2 w-full mb-2 dark:text-white dark:bg-abutua">
                                        <option value="Mendan">Medan</option>
                                        <option value="Parapat">Parapat</option>
                                        <option value="Tarutung">Tarutung</option>
                           
                                    </select>
                                    <label class="dark:text-white " for="to">To:</label>
                                    <select name="to" id="to" class="border rounded p-2 w-full mb-2 dark:text-white dark:bg-abutua">
                                        <option value="Medan">Medan</option>
                                        <option value="Parapat">Parapat</option>
                                        <option value="Tarutung">Tarutung</option>
                            
                                    </select>
                                    <label for="jumlah_penumpang" class="dark:text-white">Jumlah Penumpang:</label>
                                    <select name="jumlah_penumpang" id="jumlah_penumpang" type="number"
                                        class=" border rounded p-2 w-full dark:text-white dark:bg-abutua">
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
                                        <option value="4">4</option>
                                    </select>
                                    <p id="harga" class="dark:text-white pb-5">Harga: Rp.100.000</p>
                                    <button
                                        class="bg-blue-500 text-white py-2 px-4 rounded mt-2 hover:bg-blue-600 dark:bg-black dark:text-white">Pesan
                                        Tiket</button>
                                </div> -->
    ...
    <section id="about" class="pt-12 dark:text-neutral-100 ">
        <div class="container px-4 mx-auto lg:py-16 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg  md:p-12 mb-8">
            <div class="flex flex-wrap">
                <div class="w-full self-center px-4 lg:w-1/2">
                    ...
                    <h2 class="font-medium text-slate-600 text-lg mb-5 lg:text-2xl dark:text-neutral-100">Transportasi</h2>
                    ...
                    </p><p class="font-medium text-justify text-secondary mb-10 leading-relaxed">
                ...
                <div class="w-full self-end px-4 lg:w-1/2">
                    ...
                    <img src="{{asset('picture/bus/2022-05-31.jpg')}}" alt="gambar" class="max-w-full mx-auto justify-items-center">
                    <span class="absolute bottom-1 -z-10 left-1/2 -translate-x-1/2 md:scale-125">
                    <svg width="400" height="400" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                    <path fill="#0F172A"d="M55,-17C62.8,6.1,54.8,35.2,37.4,46.8C20,58.3,-6.7,52.2,-28.6,36.9C-50.4,21.6,-67.3,-2.9,-61.8,-23C-56.2,-43.1,-28.1,-58.9,-2.2,-58.2C23.6,-57.4,47.2,-40.2,55,-17Z" transform="translate(100 100) scale (1.1)" />
                    </svg>
                    </span>
