                    ...
                    <div class="w-full max-w-xl p-8 scroll-pb-16 space-y-8 sm:p-8 bg-slate-100 rounded-lg shadow-2xl dark:bg-gray-800">
                        ...
                        <form action="{{ route('registrasi') }}" class="mt-8 space-y-6" method="POST" enctype="multipart/form-data">
                            ...
                            <div>
                                ...
                                <input type="date" name="tgllahir" id="tgllahir" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required>
                            </div>
                            <div>
