                    ...
                    <ul class="pb-2 space-y-2">
                        ...
                        <li>
                            ...
                            <ul id="dropdown-crud" class="space-y-2 py-2 ">
                                ...
                                <li>
                                    <a href="/tiket"
                                        class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">TIket</a>
                                </li>
                                <li>
                                    <a href="/usercontrol"
                                        class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700  bg-gray-100 dark:bg-gray-700 ">Control
                                        Users</a>
                                </li>
                            </ul>
                        </li>
                ...
                <div class="items-center hidden mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0 dark:divide-gray-700">
                    <form class="lg:pr-3" action="#" method="GET">
                        ...
                        <div class="relative mt-1 lg:w-64 xl:w-96">
                            <input type="text" name="email" id="datatable-search-input"
                        ...
                        <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                            <thead class="bg-gray-100 dark:bg-gray-700">
                                <tr>
                                    ...
                                    </th arial-sort="ascending" class="grup">
                                    <th scope="col"
