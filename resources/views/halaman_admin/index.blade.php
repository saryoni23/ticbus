        ...
        <nav
            ...
            <div class="flex flex-wrap justify-between items-center">
                ...
                <div class="flex items-center lg:order-2">
                    ...
                    <!-- Dropdown menu -->
                    <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700 xl:rounded-xl"
                    ...
                    <!-- Dropdown menu -->
                    <div class="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 xl:rounded-xl"
                        id="dropdown">
                        <div class="py-3 px-4">
                            <span
                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        <button type="button"
                            ...
                            aria-expanded="false">
                            <svg class="w-6 h-6  text-gray-500 transition duration-75{{ request()->routeIs('berita.index','berita.create') ? 'font-medium text-gray-900 dark:text-gray-100  dark:bg-gray-600' : '' }}"
                    ...
                    <li>
                        <button type="button"
                            ...
                            <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item="">Tiket</span>
                            <svg sidebar-toggle-item="" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                    d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                        ...
                        <ul id="dropdown-layouts3"
                            ...
                            <li>
                                <a href="{{ route('kelolatiket.create') }}"
                    ...
                    <li>
                        <button type="button"
                            ...
                            <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item="">Rute</span>
                            <svg sidebar-toggle-item="" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                    d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                        ...
                        <ul id="dropdown-layouts4"
                            ...
                            <li>
                                <a href="{{ route('kelolarute.create') }}"
