                                        ...
                                        <table id="example" class="stripe hover"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td
                                                        class="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs dark:text-white">
                                                        Rp {{ number_format($post->harga_tiket, 0, ',', '.') }}</td>
                                                    <td
                                                        class="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs dark:text-white">
                                                        {{ $post->kategori->name_categori }}
                                                    <td
                                                        class="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs dark:text-white">
                                                        {!! $post->rute->kota_asal !!} Ke {!! $post->rute->kota_tujuan !!}</td>
                                                    <td
                                                        class="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs dark:text-white">
                                                        {!! $post->jumlah_tiket !!}</td>
                                                    <td class="text-center">
                                                        <form onsubmit="return confirmHapus(event)"
                                                            action="{{ route('kelolatiket.destroy', $post->id) }}"
                                                            method="POST">
                                                            <a href="{{ route('kelolatiket.edit', $post->id) }}"
