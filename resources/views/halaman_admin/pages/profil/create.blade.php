...
<main class="p-4 md:ml-64  pt-20 bg-gray-200 dark:bg-gray-900 h-screen">
    <div class="p-4 rounded mb-4 shadow bg-white dark:bg-gray-800">
            ...
            <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('profilusaha.store') }}"
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">Buat
                            Profil</span>
                    </div>
                </li>
            </ol>
        ...
        <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
            ...
            <form action="{{ route('buatprofilcreate') }}" class="max-w-md mx-auto" method="POST"
                ...
                <div class="relative z-0 w-full mb-5 group">
                    ...
                    <input type="text" name="nama_perusahaan" id="nama_perusahaan"
                        ...
                        placeholder=" " value="{{ old('nama_perusahaan') }}" required />
                ...
                <div class="relative z-0 w-full mb-5 group">
                    ...
                    <input type="text" name="singkatan_namausaha" id="singkatan_namausaha"
                        ...
                        placeholder=" " value="{{ old('singkatan_namausaha') }}" required />
                ...
                <div class="relative z-0 w-full mb-5 group">
                    ...
                    <input type="text" name="alamat" id="alamat"
                        class="@error('alamat') is-invalid @enderror block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                ...
                <div class="relative z-0 w-full mb-5 group">
                    ...
                    <textarea type="text" name="visi" id="visi"
                        ...
                        placeholder=" " value="{{ old('visi') }}" /></textarea>
                ...
                <div class="relative z-0 w-full mb-5 group">
                    ...
                    @enderror
                    <label for="image" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Isi</label>
