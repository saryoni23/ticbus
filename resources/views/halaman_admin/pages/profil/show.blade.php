            ...
            <header class="mb-4 lg:mb-6 not-format">
                <address class="flex items-center mb-6 not-italic">
                    <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                        <img class="mr-4 w-16 h-16 " src="{{ asset('picture/logo/'.$post->logo) }}" alt="">
                        <div>
                            <a href="#" rel="author"
                                class="text-xl font-bold text-gray-900 dark:text-white">{{ $post->nama_perusahaan }}</a>
                            <p class="text-base text-gray-500 dark:text-gray-400">{{ $post->singkatan_namausaha }}</p>
                ...
                <h1
                    ...
                    {!! strip_tags($post->visi, '<strong><em><span><div>') !!}
                </h1>
