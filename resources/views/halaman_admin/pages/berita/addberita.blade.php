...
<main class="p-4 md:ml-64  pt-20 bg-gray-200 dark:bg-gray-900 h-screen">
    <div class="p-4 rounded mb-4 shadow bg-white dark:bg-gray-800">
        ...
        <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
            <form action="{{ route('berita.store') }}" class="max-w-md mx-auto" method="POST" enctype="multipart/form-data">
                @csrf
                @if ($errors->any())
                ...
                <div class="grid md:grid-cols-2 md:gap-6 mt-4">
                    ...
                    @enderror
                    <div class="relative z-0 w-full mb-5 group">
                        <label for="image" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Foto
                            Profil</label>
