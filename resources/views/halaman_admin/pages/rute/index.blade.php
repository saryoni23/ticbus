                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('kelolarute.index') }}"
                            class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">Rute</a>
                    </div>
                </li>
                <li>
                    <div class="flex items-center">
                                        ...
                                        <table id="example" class="stripe hover"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs dark:text-white">
                                                        {{ $tiket->rute->kota_asal }}</td>
                                                       
                                                    </td>
                                                    <td
                                                        class="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs dark:text-white">
                                                        {{ $tiket->rute->kota_tujuan }}</td>
                                                    <td
                                                        class="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs dark:text-white">
                                                        Jam {{ date('H:i', strtotime($tiket->jam_berangkat)) }}</td>
                                                    <td
                                                        class="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs dark:text-white">
                                                        Jam {{ date('H:i', strtotime($tiket->jam_tiba)) }}
                                                    <td
                                                        class="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs dark:text-white">
                                                    ...
                                                    <td
                                                        class="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs dark:text-white">
                                                        Rp {{ number_format($tiket->harga_tiket, 0, ',', '.') }}</td>
                                                    <td
                                                        class="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs dark:text-white">

                                                        {{ $tiket->kategori->nama_categori }}
                                                ...
                                                <td>
                                                    ...
                                                    <td class="text-center">
                                                        <form onsubmit="return confirmHapus(event)"
                                                            action="{{ route('kelolarute.destroy', $tiket->id) }}"
                                                            method="POST">
                                                            <a href="{{ route('kelolarute.edit', $tiket->id) }}"
