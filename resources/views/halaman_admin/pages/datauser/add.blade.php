            ...
            <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="/adduser"
                            class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">Tambah
                            User</a>
                    </div>
                </li>
                <li>
            ...
            @endif
                <div class="relative z-0 w-full mb-5 group">
                    <input type="text" name="fullname" id="fullname"
                        ...
                        placeholder=" " value="{{ old('fullname') }}" required />
                    <label for="fullname"
