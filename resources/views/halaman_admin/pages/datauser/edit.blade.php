    ...
    <div class="p-4 rounded mb-4 shadow bg-white dark:bg-gray-800">
        ...
        <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
            @if ($errors->any())
                ...
                @endif
            @foreach ($uc as $item)
            <form action="/edituser" class="max-w-md mx-auto" method="POST">
                @csrf
                ...
                <div class="relative z-0 w-full mb-5 group">
                    ...
                    <input type="number" name="nomor" id="nomor"
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300  dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer form-input [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"value="{{ $item->nomor }}" />
