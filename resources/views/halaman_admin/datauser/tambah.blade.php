                        ...
                        <form action="{{ route('registrasi') }}" class="mt-8 space-y-6" method="POST"
                            ...
                            <div>
                                ...
                                <input type="file" name="gambar" id="gambar"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    required>
                            </div>
                            ...
                            <div class="container items-center flex flex-col">
                                ...
                                <div class="text-sm font-medium text-gray-500 dark:text-gray-400 pt-4">
                                    Akun Sudah Siap ? <a href="{{ Route('auth') }}"
                                        class="text-primary-700 hover:underline dark:text-primary-500">Login Disini</a>
                                </div>
                            </div>
                        </form>
                    </div>
                </div>
                <div class="relative inset-x-0 top-[calc(100%-1rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-1rem)]"
                    aria-hidden="true">
                    <div class="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-[#61d066] to-[#9089fc] opacity-30 sm:left-0[calc(90%+7rem)] sm:max-w-lg"
                        style="
                            clip-path: polygon(
                                74.1% 44.1%,
                                100% 61.6%,
